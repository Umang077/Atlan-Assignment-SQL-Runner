  ...
  return (
    <div className='max-h-[32vh] overflow-auto'>
      ...
      {list.length > 0 ? (
        ...
        <div className='text-opacity-30 font-bold text-2.5xl flex flex-col h-full items-center justify-center mt-8 text-center placeholder-text'style={{marginTop:'2px'}}>
