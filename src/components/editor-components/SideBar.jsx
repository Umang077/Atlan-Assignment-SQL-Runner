...
const SideBar = () => {
  ...
  return (
    ...
    <div className='rounded-md m-4 h-full p-4 bg-gray-100 border-r border-gray-100 flex flex-col gap-2 justify-between'style={{boxShadow:'0 5px 15px 0 rgba(0 0 0 )', borderRadius:'13px', height:'592px', marginTop:'10px'}}>
      ...
      <div className='min-h-[34vh]'>
        <div className="mb-2 flex justify-between"style={{marginTop:'20px'}}>
        <h5>
